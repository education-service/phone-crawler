...
public class qqDetail {
	...
	public void getContent() {
		try {
...

			{
				...
				Pattern patt_detail13 = Pattern.compile("电   话：(.*?) ");
				Matcher matcher_detail13 = patt_detail13.matcher(result);

				while (matcher_detail13.find()) {
					strtelephone = matcher_detail13.group(1);
					System.out.println("/////telephone" + matcher_detail13.group());
				}
			...
			int count = selectmysql.select(2, strname, selNum);
			if (count == 0) {
	...
	public static void main(String[] args) throws IOException {
		//String url1="http://epg.tvsou.com/programys/TV_1/Channel_1774/W7.htm";
		String url1 = "http://www.baidu.com/s?ie=utf-8&f=8&rsv_bp=1&rsv_idx=1&tn=baidu&wd=530180782%40qq.com%20&rsv_pq=c78e320500021ac6&rsv_t=e01czvoDW99AvvyKJeA8rpJPmhuj4lA6bDv1PAWzPwwRYuwXcjq7ktO9KAM&rsv_enter=0&rsv_sug3=1&rsv_sug4=520&rsv_sug1=1";
		qqDetail crawler = new qqDetail();
		crawler.getUrl(url1);
	}
